...
public class ServerConfig {
    ...
    ServerConfig(ForgeConfigSpec.Builder innerBuilder) {
        ...
        this.canoeWoodRestriction = builder.apply("canoeWoodRestriction")
                .comment("Force creation of canoes from specified wood types. Turning this to false will make canoes craftable from any wood type.").define("canoeWoodRestriction", true);

        this.shipWoodRestriction = builder.apply("shipWoodRestriction")
                .comment("Force creation of ships and rowboats from specified wood types. Turning this to false will make ships and rowboats craftable from any wood type.").define("shipWoodRestriction", true);
        ...
        this.disableVanillaBoatFunctionality = builder.apply("disableVanillaBoatFunctionality").comment("Disables vanilla boats and base TFC boats from working.")
