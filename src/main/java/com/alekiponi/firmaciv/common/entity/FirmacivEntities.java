...
public final class FirmacivEntities {
    ...
    public static final Map<RegistryWood, RegistryObject<EntityType<CanoeEntity>>> CANOES = registerCanoeEntities();
    public static final Map<BoatVariant, RegistryObject<EntityType<RowboatEntity>>> ROWBOATS = Helpers.mapOfKeys(
            BoatVariant.class, variant -> ENTITY_TYPES.register("rowboat/" + variant.getName(),
                    () -> EntityType.Builder.of(RowboatEntity::new, MobCategory.MISC).sized(1.875F, 0.625F)
                            .build(new ResourceLocation(MOD_ID, "rowboat/" + variant.getName()).toString())));
    public static final RegistryObject<EntityType<KayakEntity>> KAYAK_ENTITY = ENTITY_TYPES.register("kayak",
            () -> EntityType.Builder.of(KayakEntity::new, MobCategory.MISC).sized(0.79F, 0.625F)
                    .build(new ResourceLocation(MOD_ID, "kayak").toString()));
    ...
    public static final RegistryObject<EntityType<WorkbenchCompartmentEntity>> WORKBENCH_COMPARTMENT_ENTITY = ENTITY_TYPES.register(
            ...
            () -> EntityType.Builder.of(WorkbenchCompartmentEntity::new, MobCategory.MISC).sized(0.6F, 0.7F)
                    .build(new ResourceLocation(MOD_ID, "compartment_workbench").toString()));
    ...
    public static final RegistryObject<EntityType<VehiclePartEntity>> VEHICLE_PART_ENTITY = ENTITY_TYPES.register(
            "vehicle_part", () -> EntityType.Builder.of(VehiclePartEntity::new, MobCategory.MISC).sized(0.025F, 0.025F)
    ...
    public static final RegistryObject<EntityType<VehicleCleatEntity>> VEHICLE_CLEAT_ENTITY = ENTITY_TYPES.register(
            "vehicle_cleat", () -> EntityType.Builder.of(VehicleCleatEntity::new, MobCategory.MISC).sized(0.4F, 0.4F)
    ...
    private static Map<RegistryWood, RegistryObject<EntityType<CanoeEntity>>> registerCanoeEntities() {
        final Map<RegistryWood, RegistryObject<EntityType<CanoeEntity>>> map = new HashMap<>();

        for (final Wood tfcWood : Wood.values()) {
            map.put(tfcWood, register("dugout_canoe/" + tfcWood.getSerializedName(),
    ...
    public static <E extends Entity> RegistryObject<EntityType<E>> register(final String name,
